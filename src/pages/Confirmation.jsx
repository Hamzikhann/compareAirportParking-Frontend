...
import { Check, CreditCard, Download, FileText, ArrowLeft } from "lucide-react";
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      {format(new Date(), "dd/MM/yyyy 'at' h:mm a")}
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="font-medium">
                        {bookingData.vehicle.vehicleManufacturer}{" "}
                        {bookingData.vehicle.vehicleModel} (
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {bookingData.registration.outboundTerminal}{" "}
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {format(
                          new Date(bookingData.payment.createdAt || new Date()),
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-[#1a4855]">
                        &pound;{bookingData.payment.totalPayment}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Contact our support team at support@yourcompany.com or
                      call +1 (555) 123-4567
                    </p>
                  </div>
                </div>
