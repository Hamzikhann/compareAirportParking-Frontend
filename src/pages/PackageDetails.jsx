		...
		>
			...
			<section className="px-20 pb-16 flex flex-col gap-5">
				<div className="w-full">
					<img className="w-[100%] h-[400px] rounded-lg" src={selectedPackage.image} alt="" />
				</div>
				<h1 className="text-2xl font-semibold text-gray-800">{selectedPackage.name}</h1>
					...
					<div className="flex flex-col gap-5 w-[67%]">
						<div className="flex items-center gap-5">
							<div className="px-4 py-4 rounded-md bg-[#f5f8f8] flex items gap-3">
								...
								<div>
									...
									<p className="text-sm font-normal text-blue-500 mb-1">(786 rating)</p>
								</div>
							</div>
							<div className="px-4 py-4 rounded-md bg-[#f5f8f8] flex flex-col items gap-3">
								<p className="flex items-center gap-2 text-gray-600 font-normal text-base">
									<FaLocationDot size={20} /> <p>27299 Wick Road , Taylor , Michigan , US 48180</p>
								</p>
								<p className="flex items-center gap-2 text-gray-600 font-normal text-base">
						...
						<div className="bg-white mt-5">
							...
							<section ref={detailsRef} className="mb-12">
								<h2 className="text-lg font-semibold text-gray-800 mb-4">Operation Hours</h2>
								...
								<div className="border border-gray-300 rounded-md overflow-hidden text-center text-sm text-gray-700">
									<div className="grid grid-cols-7 bg-gray-50 border-b border-gray-300">
										{["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].map((day) => (
											<div key={day} className="p-2 border-r last:border-r-0 border-gray-300">
												{day}
											</div>
										))}
									</div>
								...
								<div className="mt-6">
									<h3 className="text-base font-semibold mb-2 text-gray-800">Arrival Info</h3>
									<ul className="list-disc list-inside text-gray-700 space-y-1">
										<li>
											Guests will drop off their vehicle at 27299 Wick Rd and be transported via free shuttle to their
											terminal.
										</li>
										<li>Vehicle will be moved by insured staff to a secure parking facility.</li>
									</ul>
								</div>

								<div className="mt-6">
									<h3 className="text-base font-semibold mb-2 text-gray-800">Airport Transportation</h3>
									<p className="text-gray-700">Shuttles are available 24 hours daily and operate every 15 minutes.</p>
								</div>

								<div className="mt-6">
									<h3 className="text-base font-semibold mb-2 text-gray-800">Shuttle Hours</h3>
									<p className="text-gray-700 mb-2">The shuttle service is available 24/7.</p>
									<div className="border border-gray-300 rounded-md overflow-hidden text-center text-sm text-gray-700">
										<div className="grid grid-cols-7 bg-gray-50 border-b border-gray-300">
											{["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].map((day) => (
												<div key={day} className="p-2 border-r last:border-r-0 border-gray-300">
								...
								<div className="mt-6">
									<h3 className="text-base font-semibold mb-2 text-gray-800">Additional Info</h3>
									<p className="text-gray-700">
										Valet Connections is located within minutes of the airport. Free shuttles run every 15 minutes,
										24/7. Make sure to arrive at least 15 minutes before your terminal time.
									</p>
									<p className="text-gray-700 mt-3">
										Book your reservation at{" "}
										<span className="text-[#17465c] font-medium">AirportParkingReservations.com</span>
									</p>
								</div>
							</section>
							...
							<section ref={locationRef}>
								...
								<p className="text-gray-700">27299 Wick Rd, Detroit, MI 48174, United States</p>
								<div className="mt-6">
									<iframe
										title="map"
						...
						<div className="bg-white flex flex-col gap-3 rounded-md shadow-lg border border-gray-300 px-5 py-5 w-full lg:sticky lg:top-3 lg:z-40">
							<div className="text-end">
								...
								<p className="font-semibold text-lg text-gray-800 mt-2">
									from <span className="text-base font-normal text-gray-700">{selectedPackage.originalPrice} </span>
									to {selectedPackage.price} <span className="text-base font-normal text-gray-700">per day</span>
								</p>
								<p className="font-bold text-xl text-gray-800 mt-2">
									{selectedPackage.price} <span className="font-normal text-gray-700">Total</span>
								</p>
							</div>
							<Button
							...
							<p className="text-gray-800 font-normal text-base">You save $108* by parking here</p>
							<p className="text-gray-600 font-light text-sm">
								*Compared to the general price of parking at DTW for 27 full days.
							</p>
						</div>
					</div>
				</div>
