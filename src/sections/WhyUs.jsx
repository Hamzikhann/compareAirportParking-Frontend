...
import { FaMobileScreen, FaRegClock, FaHandHoldingHeart } from "react-icons/fa6";
...
function WhyUs() {
	...
	return (
		<>
			<section className="bg-white px-4 sm:px-8 lg:px-20 py-14 flex flex-col gap-14 items-center">
				<h1 className="text-3xl sm:text-4xl lg:text-5xl text-gray-800 text-center">Why Park With Us?</h1>
				<div className="flex flex-col lg:flex-row gap-10 justify-between w-full items-center lg:items-start">
					<div className="flex flex-col gap-8 w-full lg:w-[52%]">
						{data.map((item, index) => {
								...
								<div key={index}>
									<div className="flex gap-4 items-start">
										...
										<div>
											...
											<p className="text-base font-normal text-gray-700">{item.desc}</p>
										</div>
									</div>
