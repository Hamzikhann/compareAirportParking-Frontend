...
function TopLocations() {
	return (
		<>
			<section className="bg-white px-4 sm:px-8 lg:px-20 py-16 flex flex-col gap-6 items-start">
				<h1 className="text-3xl sm:text-4xl lg:text-5xl text-gray-800">Top Locations</h1>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full h-auto lg:h-[80vh]">
					...
					<div className="flex flex-col gap-6">
						...
						<div className="relative w-full h-32 lg:h-[35%] overflow-hidden rounded-xl group cursor-pointer">
							...
							<div className="absolute inset-0 bg-black bg-opacity-20"></div>
							<div className="relative flex items-center justify-center h-full">
								<h1 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold tracking-wide">SEATAC</h1>
							</div>
						</div>
					</div>
					{/* column-2 */}
					<div className="relative w-full h-64 lg:h-full overflow-hidden rounded-xl group cursor-pointer">
						...
						<div className="absolute inset-0 bg-black bg-opacity-20"></div>
						<div className="relative flex items-center justify-center h-full">
							<h1 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold tracking-wide">DETROIT</h1>
						</div>
					</div>
					{/* column-3 */}
					<div className="flex flex-col gap-6">
						<div className="relative w-full h-32 lg:h-[35%] overflow-hidden rounded-xl group cursor-pointer">
							...
							<div className="absolute inset-0 bg-black bg-opacity-20"></div>
							<div className="relative flex items-center justify-center h-full">
								<h1 className="text-white text-xl sm:text-2xl lg:text-3xl font-bold tracking-wide">LOS ANGELES</h1>
							</div>
						</div>
						<div className="relative w-full h-64 lg:h-[65%] overflow-hidden rounded-xl group cursor-pointer">
							<div
							...
							<div className="absolute inset-0 bg-black bg-opacity-20"></div>
							<div className="relative flex items-center justify-center h-full">
								<h1 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold tracking-wide">MINNEAPOLIS</h1>
							</div>
						</div>
					</div>
				</div>
