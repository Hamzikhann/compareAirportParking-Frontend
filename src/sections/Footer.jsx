...
import { FaArrowRight, FaLinkedin, FaFacebookF, FaYoutube } from "react-icons/fa";
import { RiInstagramFill } from "react-icons/ri";

const Footer = () => {
	return (
		<footer className="bg-[#0e252c] rounded-t-3xl pt-10 pb-6 px-4 sm:px-6 md:px-16">
			{/* Top Section */}
			<div className="flex flex-col sm:flex-row items-center justify-between mb-10 gap-4">
				<img src={logo} alt="Logo" className="w-[150px] sm:w-[200px] rounded-md object-contain" />
			...
			<div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8 md:gap-16">
				...
				<div className="flex-1 max-w-md">
					<p className="text-gray-300 text-base sm:text-lg mb-4">
						Subscribe to our newsletter and find out about discounts, raffles and many other surprises.
					</p>
					...
					<p className="text-[12px] text-gray-300 mt-3 leading-relaxed">
						*By subscribing you accept our Privacy Policy to receive commercial communications from Parclick. Without
						any obligation, you can unsubscribe whenever you want in the same newsletter.
					</p>
				</div>
				{/* Middle Section - Links */}
				<div className="flex flex-wrap gap-8 sm:gap-12 md:gap-20">
					<div>
						<h4 className="font-semibold text-sm sm:text-[15px] mb-3 text-white">About Parclick</h4>
						<ul className="space-y-2 text-sm sm:text-[14px] text-gray-400">
							<li>Who are we?</li>
							<li>How it works</li>
							<li>Our car parks</li>
						</ul>
					...
					<div>
						<h4 className="font-semibold text-sm sm:text-[15px] mb-3 text-white">Shall we collaborate?</h4>
						<ul className="space-y-2 text-sm sm:text-[14px] text-gray-400">
							<li>Professionals</li>
					...
					<div>
						<h4 className="font-semibold text-sm sm:text-[15px] mb-3 text-white">Contact</h4>
						<ul className="space-y-2 text-sm sm:text-[14px] text-gray-400">
							<li>Contact us</li>
							<li>FAQ</li>
						</ul>
			...
			<div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 justify-end mt-6">
				...
				<div className="w-full sm:w-auto">
					...
					<div className="flex gap-4 sm:gap-6 justify-center sm:justify-start">
						<img src={paypal} alt="PayPal" className="w-[50px] sm:w-[70px] object-contain" />
						<img src={visa} alt="Visa" className="w-[50px] sm:w-[70px] object-contain" />
						<img src={mastercard} alt="Mastercard" className="w-[50px] sm:w-[70px] object-contain" />
						<img src={gPay} alt="Google Pay" className="w-[50px] sm:w-[70px] object-contain" />
					</div>
				</div>
			</div>
			{/* Bottom Section */}
			<div className="border-t border-gray-200 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
				<p className="text-xs sm:text-sm font-normal text-white text-center">
					©2025 Airport Parking. All rights reserved
				</p>
			</div>
		</footer>
	);
